...
$PTH/flagcalc -r 10 20 100 -a s="FORALL ([Knc](n,1) IFF EXISTS (FORALL (FORALL (a == b OR EXISTS (a ELT e AND b ELT e, e IN [E]) , a IN s), b IN s), s IN [Sizedsubset]([V],n)), n IN [NN]([dimm]+1))" all -v i=minimal3.cfg
...
$PTH/flagcalc -r 5 5 1 -a s="EXISTS (s == [E], s IN [P]([Sizedsubset]([V],2)))" all
$PTH/flagcalc -r 4 5 1 -a s="EXISTS ([st](s) == 2 AND s == [E], s IN [P]([P]([V])))" all
$PTH/flagcalc -r 6 10 10 -a s="FORALL (EXISTS (FORALL (FORALL ((b ELT e) AND (c ELT e), c IN a), b IN a), a IN [Sizedsubset]([V],2)), e IN [E])" all -v i=minimal3.cfg
$PTH/flagcalc -r 6 10 10 -a s="FORALL (e ELT [Sizedsubset]([V],2), e IN [E])" all -v i=minimal3.cfg
$PTH/flagcalc -r 6 10 15 -a s="EXISTS (FORALL (FORALL (FORALL (EXISTS (c ELT e AND b ELT e, e IN [E]), c IN a), b IN a), a IN s), s IN [P]([Sizedsubset]([V],2)))" all -v i=minimal3.cfg
$PTH/flagcalc -r 6 10 15 -a s="EXISTS (FORALL (a ELT [E], a IN s), s IN [P]([Sizedsubset]([V],2)))" all -v i=minimal3.cfg
